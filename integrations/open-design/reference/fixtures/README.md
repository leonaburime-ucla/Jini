...
path transform must rewrite to `integrations/open-design/daemon/src/routes/health.ts`
...
rename; the real target is the current `integrations/open-design/` layout).
