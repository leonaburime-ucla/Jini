...
exactly one, see `automation/project-runner/cloud-routine-prompt.md`) or a
...
lineage — see the correction below) that `docs/jini-port/recon/r5-components-sweep.md`
analyzed. Copied verbatim, 2026-07-16.

**Provenance caveat (same one flagged in `docs/jini-port/od-reference-branches.md`
...
**The plan for what to do with these files:** `docs/jini-port/ui-extraction-plan.md`.
