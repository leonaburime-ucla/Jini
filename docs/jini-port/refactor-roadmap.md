...
| `@jini/chat-react` | **Next** — spec fully written (r4b §1.2/§2/§3/§4); source is the chat-pane-slice/chat-composer-slice branches (`docs/jini-port/od-reference-branches.md`), both public |
