...
The **execution runtime** for Jini's agent-driven extraction — the one piece the automation stack is missing (AI-Dev-Shop is declarative pipeline defs; ADS-memory is durable decisions; this is the executor). See `docs/jini-port/extraction-plan.md` §12 C6.
