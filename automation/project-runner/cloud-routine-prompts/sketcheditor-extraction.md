...
2. Jini branch and SHA. SketchEditor.tsx has no known live-OD-branch
   ...
   reference in docs/jini-port/od-reference-branches.md) -- the vendored
   snapshot at integrations/open-design/reference/components-original/
...
- docs/jini-port/recon/r6-god-component-internals.md section 1.22
