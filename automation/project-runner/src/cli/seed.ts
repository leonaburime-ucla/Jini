 ...
 *
 * Idempotently derives the §8 extraction DAG from `docs/jini-port/extraction-plan.md`,
  ...
  try {
    ...
    console.warn(
      '[seed] proceeding: new/renamed WorkItems will be added, but existing WorkItem ' +
        'ids are never rewritten from stale text — review docs/jini-port/extraction-plan.md ' +
