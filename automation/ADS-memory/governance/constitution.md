...
Copy this file to `ADS-memory/governance/constitution.md`. Fill in each article with your project's specific rules. Delete placeholder comments. The Spec Agent and Software Architect Agent read this file on every run — every article they cannot comply with must be either justified in the ADR's Complexity Justification table or escalated to the human.
