/**
 * @module @jini/metatool
 *
 * Build-metadata hash/check/write mechanics for a repo-local tool's build outputs
 * (`meta.json` policy in, `dist/metadata.json` hash out). Ported speculatively — see
 * `source-map.md` for why this package exists with no current consumer.
 */
