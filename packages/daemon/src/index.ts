 ...
 * §2.5 / §8 task 6), the generic `ArtifactStore` kernel port, and
 * `AgentExecutor` — the driver that wires `@jini/agent-runtime` into
 * `RunLifecycle` (extraction-plan §2.1 / §3). See `source-map.md` for full
