...
Per `ADS-memory/reports/jini-port/recon/r4b-webui-design.md` §1 ("`@jini/artifacts-react` —
...
(`ADS-memory/reports/jini-port/skills/fixing-open-design-web.md` Phase 9.5) both
