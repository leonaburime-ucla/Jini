...
/**
 * Card-shaped skeleton for grid layouts (thumbnail area over a row of meta
 * lines) so an empty grid feels like content is arriving rather than
 * missing.
 */
...
/**
 * Centered overlay used while bootstrap data loads. Sits inside a flex/grid
 * parent and grows with it.
 */
