...
## the host platform orchestration mode

When this skill is invoked inside the host platform, treat it as the design-flow
...
3. Search across every available the host platform resource, not only this skill:
