...
> **the host platform integration.** This is the unmodified Codex `hatch-pet` skill,
> vendored under `skills/hatch-pet/` so any the host platform agent can run it. After
