...
`ADS-memory/reports/jini-port/extraction-plan.md`.** Per that doc's precedent for
...
built per the task-6 audit's PART A brief off `ADS-memory/reports/jini-port/recon/
