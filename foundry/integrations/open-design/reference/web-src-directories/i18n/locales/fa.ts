...
export const fa: Dict = {
  ...
  "settings.allowSilentUpdates": "اجازه به‌روزرسانی بی‌صدا",
  "settings.allowSilentUpdatesDesc": "به‌روزرسانی‌های payload دانلودشده را هنگام راه‌اندازی خودکار اعمال کن. به‌روزرسانی‌های نصاب همچنان ابتدا تأیید می‌خواهند.",
  ...
  'updater.later': 'بعداً',
  "updater.allowSilentUpdates": "اجازه به‌روزرسانی بی‌صدا",
  ...
  'workspaceAssistant.fabLabel': 'باز کردن دستیار فضای کاری',
  'workspaceAssistant.title': 'دستیار',
  'workspaceAssistant.close': 'بستن',
  'workspaceAssistant.loading': 'در حال بارگذاری…',
  'workspaceAssistant.viewMode': 'حالت نما',
  'workspaceAssistant.viewModeOverlay': 'روی‌هم',
  'workspaceAssistant.viewModeSquish': 'فشرده',
  'workspaceAssistant.viewModeDetach': 'باز کردن در پنجره',
};
