...
2. Jini branch and SHA. This environment has ONE repo source -- the
   ...
   foundry/integrations/open-design/reference/components-original/NewAutomationModal.tsx
...
- foundry/docs/jini-port/recon/r6-god-component-internals.md section 1.19
