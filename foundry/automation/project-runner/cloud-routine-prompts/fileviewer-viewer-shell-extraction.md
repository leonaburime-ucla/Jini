...
`foundry/docs/jini-port/god-components-extraction-plan.md`, `FileViewer.tsx` is an **own feature**
...
1. Read foundry/docs/jini-port/god-components-extraction-plan.md in full, in
   ...
   foundry/integrations/open-design/reference/components-original/DesignBrowserPanel.tsx)
...
2. Jini branch and SHA. No known live-OD-branch durability concern for this
   target (no tracked PR reference in foundry/docs/jini-port/od-reference-branches.md)
   -- the vendored snapshot at
   foundry/integrations/open-design/reference/components-original/FileViewer.tsx is
...
- foundry/docs/jini-port/recon/r6-god-component-internals.md section 1.1
