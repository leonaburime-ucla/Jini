...
/** Package root: `foundry/automation/project-runner/`. */
export const PACKAGE_ROOT = join(HERE, '..', '..');

/** Repo root, five levels up from `src/cli/` after the package moved under `foundry/`. */
export const REPO_ROOT = join(PACKAGE_ROOT, '..', '..', '..');

/** The locked architecture doc this DAG is derived from. */
export const EXTRACTION_PLAN_PATH = join(
  REPO_ROOT,
  'foundry',
  'docs',
  'jini-port',
